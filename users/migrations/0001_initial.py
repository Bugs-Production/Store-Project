    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('N', 'Не выбрано'), ('M', 'Мужской'), ('G', 'Женский')], default='N', max_length=1, verbose_name='Пол')),
                ('email_verification', models.BooleanField(default=False, verbose_name='Статус верификации')),
